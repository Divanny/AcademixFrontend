export const CustomerService = {
  getHistorial() {
    return [
      {
        materiaId: 1,
        descripcion: "Calculo Diferencial",
        codigoAsignatura: "CBM-208",
        literal: "A",
        fechaAprobada: "2023-10-31",
        prerrequisito: ["CBM-202", "CBM-203", "CBM-204"],
        trimestre: {
          trimestreId: 1,
          descripcion: "Trimestre 1",
        },
        maestro: {
          maestroId: 2,
          descripcion: "Nehomar Lezama",
        },
        estado: "Aprobada",
      },
      {
        ...
        codigoAsignatura: "FQI-101",
        literal: "A",
        fechaAprobada: "2023-11-01",
        prerrequisito: ["CBM-202", "CBM-203", "CBM-204"],
        trimestre: {
          trimestreId: 1,
          descripcion: "Trimestre 1",
      ...
      },
      {
        ...
        codigoAsignatura: "HUS-302",
        literal: "A",
        fechaAprobada: "2023-12-31",
        prerrequisito: ["CBM-202", "CBM-203", "CBM-204"],
        trimestre: {
          trimestreId: 3,
          descripcion: "Trimestre 3",
        },
        maestro: {
          maestroId: 10,
          descripcion: "Maria Hernandez",
        },
        estado: "Aprobada",
      },
      {
      ...
      },
      {
        ...
        codigoAsignatura: "FQI-204",
        literal: "A",
        fechaAprobada: "2023-11-01",
        prerrequisito: ["CBM-202", "CBM-203", "CBM-204"],
        trimestre: {
          trimestreId: 2,
          descripcion: "Trimestre 2",
        },
        maestro: {
          maestroId: 6,
          descripcion: "Jose Garcia",
        },
        estado: "Reprobada",
      },
      {
        materiaId: 62,
        descripcion: "Calculo Integral",
        codigoAsignatura: "CBM-209",
        literal: "A",
        fechaAprobada: "2023-11-01",
        prerrequisito: ["CBM-202", "CBM-203", "CBM-204"],
        trimestre: {
      ...
      {
        materiaId: 97,
        descripcion: "Redes de Computadoras",
        codigoAsignatura: "RC-310",
        literal: "A",
        fechaAprobada: "2023-12-31",
        prerrequisito: ["CBM-202", "CBM-203", "CBM-204"],
        trimestre: {
      ...
      {
        materiaId: 100,
        descripcion: "Trabajo de Graduacion",
        codigoAsignatura: "TG-313",
        literal: "A",
        fechaAprobada: "2023-12-31",
        prerrequisito: ["CBM-202", "CBM-203", "CBM-204"],
        trimestre: {
      ...
      },
      {
        ...
        codigoAsignatura: "IA-401",
        literal: "A",
        fechaAprobada: "2023-12-31",
        prerrequisito: ["CBM-202", "CBM-203", "CBM-204"],
        trimestre: {
          trimestreId: 4,
          descripcion: "Trimestre 4",
        },
        maestro: {
          maestroId: 23,
          descripcion: "María Rodríguez",
        },
        estado: "Aprobada",
      },
      {
      ...
      },
      {
        ...
        codigoAsignatura: "EA-401",
        literal: "A",
        fechaAprobada: "2024-12-31",
        prerrequisito: ["EA-201", "EA-202", "EA-301"],
        trimestre: {
          trimestreId: 4,
          descripcion: "Trimestre 4",
        },
      ...
      {
        materiaId: 106,
        descripcion: "Análisis de Algoritmos",
        codigoAsignatura: "AA-501",
        literal: "A",
        fechaAprobada: "2025-12-31",
        prerrequisito: ["AA-301", "AA-401"],
        trimestre: {
          trimestreId: 5,
          descripcion: "Trimestre 5",
        },
        maestro: {
          maestroId: 27,
          descripcion: "Laura Ramírez",
        },
        estado: "Aprobada",
      },
    ];
...
/* cambia */
  ...
  getHistorialAcademico() {
    return Promise.resolve(this.getHistorial());
  },
